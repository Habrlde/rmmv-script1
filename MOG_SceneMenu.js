...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_SceneMenu');
	...
	Moghunter.src_main_Layout2 = String(Moghunter.parameters['资源-整体布局(明也视角)']);
...
Scene_Menu.prototype.refreshTime = function() {
	...
	this._playTimeSec = this.playTimeSec();
//此处改成了显示金钱
	this._playTime.bitmap.drawText($gameParty.gold()+'  円',0,0,200,32,"right");
};
...
//明也视角的主菜单变化
if ($gameSwitches.value(159)==true){
this._layout = new Sprite(ImageManager.loadMenusMain(Moghunter.src_main_Layout2));
}
else {
